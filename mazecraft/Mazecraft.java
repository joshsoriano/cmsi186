...
/**
 * Mazecraft is a demonstration application that builds a mouse maze, displays
 ...
 */
public class Mazecraft {
    /**
     * Launches Mazecraft. The maze to use depend on what is provided via
    ...
    private static void displayUsageMessage() {
        System.out.println("Usage: java Mazecraft <Steve x> <Steve y> <pig x> <pig y>");
        System.out.println();
